...
/**
 * Interface for parsing TypedSure type annotations.
 */
export interface TypedSureParserInterface {
    /**
     * Parses fixture metadata from a TypedSure type annotation on a constructor or factory method.
     *
    ...
    /**
     * Parses scenario metadata from a TypedSure type annotation on a method or function.
     *
    ...
    /**
     * Parses skip metadata from a TypedSure type annotation.
     *
     * @param node The method or function declaration node.
     * @param typeChecker The TypeScript type checker.
